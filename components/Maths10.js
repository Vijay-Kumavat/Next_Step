...
export default class Maths10 extends React.Component {
  render() {
    ...
    const htmlContent1 = `<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Students who are willing to pursue for technical and research fields, they have to opt Mathematics stream in Class 11.</p>`;
    ...
    const htmlContent8 =`<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Maths is always like you have to just do it regularly and nothing will go wrong.</p>`;
    ...
    const htmlContent13 = `<p><ul><li>Physics</li><li>Chemistry</li><li>English</li><li>Mathematics</li><li>Computer Science/Hindi/Sanskrit etc.</li></ul></p>`;
    ...
    return (
        ...
        <View style={styles.e}>
          <Image source={require('images/4.jpg')} style={styles.d} />
        </View> 
        <View style={styles.container}>
          <Text style={styles.f}>11 Science PCM</Text>
          ...
          <Text style={styles.f}>12 Science PCM</Text>
