...
export default class MathsBiology10 extends React.Component {
  render() {
    ...
    const htmlContent1 = `<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Students who are willing to pursue for technical and research fields, they have to opt Maths-biology stream in Class 11.</p>`;
    const htmlContent2 =`<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;How many percent needed in class 11 to take PCM or PCB after class 10?</b></p>`;
    const htmlContent3 =`<p><b><ul><li>You will get Science if you will score 90% above..</li><li>If you will score good in maths and science above 80 out of 100 your school will give you Science they will not see your marks in SST,English or hindi.</li><li>But sometimes students who score around 70-80% also get Science.Due to their active performance during class.If you have a good image in front of teachers and you always give answers in your class.You can get Science.</li></ul></b></p>`;
    ...
    const htmlContent8 =`<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Maths-Biology is always like you have to just do it regularly and nothing will go wrong.</p>`;
    ...
    const htmlContent12 = `<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The major subjects covered under the Science stream are:</b></p>`;
    const htmlContent13 =`<p><ul><li>Physics</li><li>Chemistry</li><li>Biology</li><li>English</li><li>Mathematics</li><li>Biotechnology</li><li>Computer Science/Hindi/Sanskrit etc.</li></ul></p>`;
    const htmlContent14 =`<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.quora.com/What-are-the-passing-marks-of-12th-science-per-subject">What are the passing marks of 12th science per subject?<b>click me</b></a></p>`;
    const htmlContent15 =`<p><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Go to the After 12 for Other Information of PCB.</b></p>`;
    return (
        <ScrollView contentContainerStyle={styles.contentContainer}>
        <View style={styles.e}>
          <Image source={require('images/10.jpg')} style={styles.d} />
        </View> 
        <View style={styles.container}>
          <Text style={styles.f}>11 Science PCMB</Text>
          <View style={styles.h}>
          ...
          <HTMLView value={htmlContent4} stylesheet={styles} />
